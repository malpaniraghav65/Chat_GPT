...
import com.example.chatgpt.MessageModel
import com.example.chatgpt.R
import java.nio.file.Files.list

class adapter(val list: ArrayList<MessageModel>) : Adapter<adapter.MessageViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MessageViewHolder, position: Int) {
        ...
        if(message.isImage){
            ...
            Glide.with(holder.itemView.context)
                .load(message.message).into(holder.imageView)
